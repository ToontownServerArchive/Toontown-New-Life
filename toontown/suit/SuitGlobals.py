...
suitProperties = {
      ...
      'cn': (3.75 / bSize, VBase4(0.95, 0.95, 1.0, 1.0), ['telemarketer', 'group', 'group1'], '', 5.24),
      'sw': (4.34 / aSize, SuitDNA.boardPolyColor, ['pennypincher'], 'swindler.jpg', 5.45),
      'mdm': (5.0 / aSize, SuitDNA.boardPolyColor, ['yesman', ''], 'middleman1.jpg', 6.7),
      ...
      'hho': (7.0 / aSize, SuitDNA.boardPolyColor, ['yesman'], 'middleman.jpg', 8.23),
}
